...
function showDeliveryNoteField() {
    ...
    textarea.placeholder = 'Add delivery instructions (e.g., company name, gate code, etc.)';
    textarea.rows = 3;
...
function initializeGiftMessage() {
    const giftCheckboxes = document.querySelectorAll('#giftMessage, #giftMessageMobile');
